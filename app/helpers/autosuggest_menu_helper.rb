...
module AutosuggestMenuHelper
  def autosuggest_menuitems
    Rails.cache.fetch("user_autocomplete_menu#{session[:user_id]}"){
      menu_items = []
      default = [
        {:menu_type => 'link' ,:label => 'autosuggest_menu.student_admission',:value => {:controller => :students,:action => :admission1}},
        ...
        {:menu_type => 'link' ,:label => 'autosuggest_menu.finance',:value =>{:controller => :finances,:action => :index}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.manage_fees',:value =>{:controller => :finances,:action => :fees_index}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.fee_collection',:value =>{:controller => :finances,:action => :fee_collection}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.fee_submission_by_course',:value =>{:controller => :finances,:action => :fees_submission_batch}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.fee_submission_for_each_student',:value =>{:controller => :finances,:action => :fees_student_search}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.finance_categories',:value =>{:controller => :finances,:action => :categories}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.transactions',:value =>{:controller => :finances,:action => :transactions}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.add_expense',:value =>{:controller => :finances,:action => :expense_create}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.expense_list',:value =>{:controller => :finances,:action => :expense_list}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.add_income',:value =>{:controller => :finances,:action => :income_create}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.income_list',:value =>{:controller => :finances,:action => :income_list}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.transaction_report',:value =>{:controller => :finances,:action => :monthly_report}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.compare_transactions',:value =>{:controller => :finances,:action => :compare_report}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.donations',:value =>{:controller => :finances,:action => :donation}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.donors',:value =>{:controller => :finances,:action => :donors}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.automatic_transactions',:value =>{:controller => :finances,:action => :automatic_transactions}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_payslip',:value =>{:controller => :finances,:action => :view_monthly_payslip}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.asset',:value =>{:controller => :finances,:action => :asset}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_assets',:value =>{:controller => :finances,:action => :view_asset}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.liability',:value =>{:controller => :finances,:action => :liability}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_liability',:value =>{:controller => :finances,:action => :view_liability}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.manage_users',:value =>{:controller => :users,:action => :index}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_users',:value =>{:controller => :users,:action => :all}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.add_users',:value =>{:controller => :users,:action => :create}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.timetable',:value =>{:controller => :timetables,:action => :index}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.create_timetable',:value =>{:controller => :timetables,:action => :select_class2}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.set_class_timings',:value =>{:controller => :class_timings,:action => :index}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_timetables',:value =>{:controller => :timetables,:action => :view}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.institutional_timetable',:value =>{:controller => :timetables,:action => :timetable}},
        ...
        {:menu_type => 'link' ,:label => 'autosuggest_menu.view_students',:value =>{:controller => :students,:action => :view_all}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.student_advanced_search',:value =>{:controller => :students,:action => :advanced_search}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.create_fees',:value =>{:controller => :finances,:action => :master_fees}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.fee_defaulters',:value =>{:controller => :finances,:action => :fees_defaulters}},
        {:menu_type => 'link' ,:label => 'autosuggest_menu.fee_structure',:value =>{:controller => :finances,:action => :fees_student_structure_search}},
